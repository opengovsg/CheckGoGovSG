...
export default function Index() {
  return (
    <>
      <LandingSection pt={{ base: "0.5rem", md: 0 }} px="0">
        <Stack
        ...
        >
          ...
          >
            ...
            <Text mt="1.5rem" textStyle="body-1" color="textDefault">
              ...
              public officers and are each associated to a single message, so
              you can be sure that it's from a trustworthy source and{" "}
